...
// act
def response = WS.sendRequestAndVerify(findTestObject('Background Tasks/Create/Create Background Task without optional key (name)', [('id') : id
...
WS.verifyElementPropertyValue(createdTask, 'name', 'someName')
