...
// act
def response = WS.sendRequestAndVerify(findTestObject('Background Tasks/Create/Create Background Task without optional keys (default values in ArgumentDescription)', 
...
WS.verifyElementPropertyValue(createdTask, 'description', 'desc')

WS.verifyElementPropertyValue(createdTask, 'argumentDescriptions[0].defaultValue', null)

WS.verifyElementPropertyValue(createdTask, 'argumentDescriptions[0].isDefaultValueProvided', false)
