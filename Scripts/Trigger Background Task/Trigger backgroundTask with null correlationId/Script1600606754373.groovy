...
def executionResponse = WS.sendRequestAndVerify(findTestObject('Background Task Executions/Get by filters/Get Background Task Executions by filters', [('queryString') : queryString]))
