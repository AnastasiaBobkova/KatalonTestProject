...
def methodName = "CorrelationIdTest"

WS.sendRequest(findTestObject('Background Tasks/Create/Create Background Task', 
	[('id') : backgroundTaskId,
...
def triggerWithExistCorrelation = WS.sendRequest(findTestObject('Background Tasks/Trigger Background Task', 
	[('taskId') : backgroundTaskId, 
	('correlationId'):"\"${correlationId}\""]))

WS.verifyResponseStatusCode(triggerWithExistCorrelation, 400)
