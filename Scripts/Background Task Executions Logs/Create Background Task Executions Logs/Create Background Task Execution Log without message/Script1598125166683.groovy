...
// act
def createLogResponse = WS.sendRequest(findTestObject('Background Task Executions Logs/Create Background Task Executions Log without message', [('id') : logId, ('executionId') : executionId]))

//assert
WS.verifyResponseStatusCode(createLogResponse, 400)
